...
Format your response in markdown to make it easier to render
 to a web page such that steps are in form of an odered list. 
 Include a title for the recipe, a list of ingredients, and the 
 steps to make the recipe. The ingredients should be in a bulleted
  list and the steps should be in an ordered list. Make sure to include
   the cooking time and serving size at the top of the recipe."
`
